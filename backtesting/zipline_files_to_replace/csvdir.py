...
def csvdir_bundle(environ,
    ...
    for tframe in tframes:
        ...
        # Failed to find any assets with country_code 'KR' that traded between 2017-10-20 00:00:00+00:00 and 2017-10-27 00:00:00+00:00.
        # This probably means that your asset db is old or that it has incorrect country/exchange metadata. 에러 해결을 위해 추가
        
        # metadata['exchange'] = "XKRX"
        # exchange = {'exchange': 'XKRX', 'canonical_name': 'XKRX', 'country_code': 'KR'}
...
# register_calendar_alias("CSVDIR", "XKRX")
