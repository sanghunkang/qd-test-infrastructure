...
from zipline.data.bundles import core
from zipline.data.bundles.csvdir import csvdir_equities



start_session = pd.Timestamp('2022-03-01 14:31:00+00:00', tz='UTC')
end_session = pd.Timestamp('2022-03-10 20:00:00+00:00', tz='UTC')

core.register(
    'etf_minute_bundle',
    csvdir_equities(
        ['minute'],
        '/Users/joseongmin/Desktop/qd-data-infrastructure/backtesting/csv',
    ),
    # calendar_name='NYSE',
    calendar_name='24/7',
...
end_session = pd.Timestamp('2022-02-08', tz='UTC')
